...
import numpy as np
import sys
sys.path.append("/home/dungmt/BEiT3/__pycache__")
from BEiT3.modeling_utils import BEiT3Wrapper, _get_base_config, _get_large_config

#sys.path.insert(0, "/mlcv1/WorkingSpace/Personal/baotg/AIC2023/source/backend/lib/BEiT3")
import BEiT3.utils_beit as utils_beit


# print(dir(utils_beit))
...
class BEiT3ForRetrieval(BEiT3Wrapper):
    def __init__(
        ...
        self.criterion = utils_beit.ClipLoss(
            rank=utils_beit.get_rank(), 
            world_size=utils_beit.get_world_size(), 
        )
